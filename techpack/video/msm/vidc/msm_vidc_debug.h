...
#define dprintk(__level, sid, __fmt, ...)	do { } while (0)

#define s_vpr_e(sid, __fmt, ...) do { } while (0)
#define s_vpr_h(sid, __fmt, ...) do { } while (0)
#define s_vpr_l(sid, __fmt, ...) do { } while (0)
#define s_vpr_p(sid, __fmt, ...) do { } while (0)
#define s_vpr_t(sid, __fmt, ...) do { } while (0)
#define s_vpr_b(sid, __fmt, ...) do { } while (0)
#define s_vpr_hp(sid, __fmt, ...) do { } while (0)
#define d_vpr_e(__fmt, ...)	do { } while (0)
#define d_vpr_h(__fmt, ...) do { } while (0)
#define d_vpr_l(__fmt, ...) do { } while (0)
#define d_vpr_p(__fmt, ...) do { } while (0)
#define d_vpr_t(__fmt, ...) do { } while (0)
#define d_vpr_b(__fmt, ...) do { } while (0)

#define dprintk_firmware(__level, __fmt, ...)	do { } while (0)

#define dprintk_ratelimit(__level, __fmt, arg...) do { } while (0)
#define MSM_VIDC_ERROR(value)	do { } while (0)
